...
namespace CarvedRock.Admin.Controllers
{
    public class ProductsDbController : Controller
    {
        ...
        public async Task<IActionResult> Create(
            [Bind("Id,Name,Description,Price,IsActive")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,IsActive")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
